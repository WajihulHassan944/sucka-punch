...
export default function OrderSummary() {
  ...
  return (
    <Card>
      <CardContent>
        <h2 className="text-2xl font-semibold text-[#044588] mb-3">Order Summary</h2>
        <Separator />
        <div className="space-y-4 mt-10">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-lg">Sucka Punch Original</h3>
              <p className="text-base">Berry Blast - Qty: {cartData.quantity}</p>
            </div>
            <p className="font-semibold text-[#044588] mt-1">${cartData.total}</p>
          </div>
          <Separator />
          ...
          <div className="flex justify-between font-bold text-lg">
            <p>Total</p>
            <p className="text-[#044588]">${totalWithDelivery}</p>
          </div>
