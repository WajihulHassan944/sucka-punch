  ...
  const contentSlides = [
    {
      ...
      description:
        "It&apos;s double identity is one of several distinguishing features of SUCKA PUNCH. At once, it&apos;s nourishing and intoxicating. Most drinks with alcohol dehydrate you. They&apos;re full of sugar and make you feel tired. This is unique. The buzz here is bundled with the fundamentals of hydration—clean water, individual control, and a revitalizing lift. You need not decide between enjoyment and thirst.",
    },
    {
      title: "A Smart Trade-Off",
      description:
        "Usually, alcohol hits hard and makes you feel weighted. Sucka Punch alters that story. You are consuming water. You&apos;re tasting. You&apos;re also receiving that nice alcohol lift. The outcome? No swelling. No sugar crash. Just good feelings. You don&apos;t get burdened. You feel incredible, light, and more in charge of your evening.",
    },
    {
      title: "Goodbye Hangovers, Hello Chill",
      description:
        "SUCKA PUNCH naturally promotes improved hydration since it advocates mixing with water. When it comes to hangover prevention, that&apos;s a big victory. You are less prone to get up with a parched throat or a pounding head. It&apos;s one minor adjustment that significantly affects your next-day mood.",
    },
    {
    ...
    },
    {
      ...
      description:
        "It&apos;s for those who understand how to pace themselves. For individuals who enjoy a light and vibrant atmosphere. SUCKA PUNCH provides the ideal middle ground whether you desire a little taste in your daily activities or you control your alcohol consumption. It&apos;s purposeful and hydrating with a twist.",
    },
  ];
