      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1">
          <div className="space-y-2">
            <h1 className="text-4xl font-bold">Sucka Punch</h1>
          ...
          <p className="text-gray-700 mt-6">
            Sucka Punch is a refreshing and invigorating drink that is perfect
